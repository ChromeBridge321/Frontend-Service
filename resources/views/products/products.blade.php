            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                @if ($error == 2)
                    <div class="alert bg-danger-subtle col-12 d-flex justify-content-center">
                        <p>A ocurrido un erro al procesar la solicitud</p>
                    </div>
                @endif
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form id="deleteForm" action="{{ route('deleteP') }}" method="POST"
                                                class=" col-12 d-flex justify-content-around align-items-center">
                                                @csrf
                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#ModalEditar{{ $item['_id']['$oid'] }}">
                                                ...
                                                <input name="id" type="text"
                                                    value="{{ $item['_id']['$oid'] }}" class=" d-none">
                                            </form>
                                        </td>
                                        <!-- Modal Editar-->
                                        <form action="{{ route('updateP') }}" method="POST">
                                            @csrf
                                            <div class="modal fade" id="ModalEditar{{ $item['_id']['$oid'] }}"
                                                            ...
                                                            <div class=" row d-flex justify-content-center">
                                                                ...
                                                                <div class=" col-9" class=" form-label">
                                                                    ...
                                                                    <input type="text" name=" ingredients"
                                                                        id="" class=" form-control"
                                                                        value="{{ implode(',', $item['ingredients']) }}"
                                                                        placeholder="Tomate, Lechuga, Cebollas">
                                                                </div>
                                                                <div class=" col-9" class=" form-label">
